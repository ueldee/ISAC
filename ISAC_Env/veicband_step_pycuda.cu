...
extern "C" {
  ...
  __device__ void CudaVeicBandGenerateObservation(
    float * loc_x_arr,
    float * loc_y_arr,
    float * speed_arr,
    float * direction_arr,
  ...
  __device__ void CudaveicbandComputeReward(
    float * rewards_arr,
    float * loc_x_arr,
    float * loc_y_arr,
    const float kGridLength,
  ...
  __global__ void CudaveicbandStep(
    float * loc_x_arr,
    float * loc_y_arr,
    float * speed_arr,
    float * direction_arr,
    ...
    // -------------------------------
    CudaveicbandGenerateObservation(
      loc_x_arr,
      loc_y_arr,
      speed_arr,
      direction_arr,
